        ...
        <div class="column is-one-third">
          <div id="profile" class="has-text-centered">
            ...
            <div class="portrait-title">
              <h2>Qiang Guo</h2>
              <h3 class="jobTitle">Web, iOS Developer</h3>
              <h3 class="worksFor">
                <a href="https://wifriend.io" target="_blank">Wifriend (@mcknight0219)</a>
              </h3>
            </div>
          </div>
        </div>
              ...
              <ul class="ul-edu">
                <li>
                  ...
                  <div class="description">
                    <p class="course">MSc in Electrical Engineering, 2012</p>
                ...
                <li>
                  <i class="fa-li fa fa-graduation-cap"></i>
                  <div class="description">
                    <p class="course">BSc in Electrical Engineering, 2009</p>
...
#contact.home-section .fa-li {
  position: absolute;
  left: -3.14285714rem;
  /* Negative of `#contact.home-section .fa-ul` margin. */
  width: 2rem;
